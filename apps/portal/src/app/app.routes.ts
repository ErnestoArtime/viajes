...
export const routes: Routes = [
  ...
  { path: 'operator/reservas', canActivate: [authGuard, roleGuard], data: { roles: ['operator', 'admin'] }, loadComponent: () => import('./features/operator-requests/operator-requests.component').then(m => m.OperatorRequestsComponent) },
  { path: 'operator/solicitudes', redirectTo: 'operator/reservas', pathMatch: 'full' },
